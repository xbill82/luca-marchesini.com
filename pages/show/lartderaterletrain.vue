  ...
  <show>
    <template slot="header">
      <img
        sizes="100vw"
        class="img-fluid"
        src="https://res.cloudinary.com/luca-le-conteur/image/upload/w_auto:100:1280/v1617091096/header-lartderaterletrain.png"
      />
    </template>
    ...
    <template slot="description">
      ...
      de partir m’installer à Montpellier. <br />
